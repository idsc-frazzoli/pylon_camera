...
``sudo sh -c 'echo "yaml https://raw.githubusercontent.com/idsc-frazzoli/pylon_camera/indigo-devel/rosdep/pylon_sdk.yaml " > /etc/ros/rosdep/sources.list.d/15-plyon_camera.list'``
